...
const Footer: React.FC = () => {
  return (
    <footer className="bg-forest text-white pt-20 pb-10 border-t border-white/10">
      <div className="container mx-auto px-6 text-center max-w-4xl">
        ...
        <a href="#oferta" className="inline-block bg-gold text-forest-dark font-bold px-10 py-4 rounded-full shadow-lg hover:bg-white transition-all transform hover:-translate-y-1 mb-16">
        ...
        <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <div className="mb-4 md:mb-0">
            <img src="http://midias.lcai.com.br/images/2025/11/24/Logo-RB-Branco.png" alt="Ricardo Borges" className="h-8 md:h-12 w-auto" />
          </div>
