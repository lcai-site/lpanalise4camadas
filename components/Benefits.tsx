      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <Reveal delay={200} className="relative">
          <div className="border border-gold/30 p-8 rounded bg-navy-800/50 backdrop-blur text-center relative z-10">
            ...
            <h3 className="font-serif text-2xl text-white mb-4">Estabilidade Emocional</h3>
            <p className="text-gray-400">
              O resultado final não é apenas sucesso externo, mas a paz interna de saber que você está no caminho certo.
            </p>
          </div>
          {/* Decorative Elements */}
